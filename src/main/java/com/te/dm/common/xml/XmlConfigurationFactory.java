...
public class XmlConfigurationFactory {
    private static final Logger logger = LogManager.getLogger(XmlConfigurationFactory.class);
    ...
    public static void main(String[] args) {
        Configuration config = XmlConfigurationFactory.loadFile("D:\\DearM\\idea_workspace\\data_acquire\\src\\main\\resources\\data_acquire.xml", Configuration.class);
